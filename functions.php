...
function thinthreadwp_theme_js() {
	...
	wp_enqueue_script( 'app_js', get_template_directory_uri() . '/assets/js/main.js', array('jquery'), '', true );
	//wp_enqueue_script( 'appmin_js', get_template_directory_uri() . '/assets/js/main.js', array('jquery'), '', true );
